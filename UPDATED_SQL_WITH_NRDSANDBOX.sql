-- ===================================================================
-- NRDSANDBOX - COMPLETE DREAMHOST SQL SETUP (CORRECTED)
...
-- Using corrected email addresses with proper domain
...
-- Check if users were created with correct data
...
SELECT username, role, pilot_callsign, preferred_theme FROM user_info;